...
class GenesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gene" do
    assert_difference("Gene.count") do
      post genes_url, params: { gene: { chromosome_number: @gene.chromosome_number, description: @gene.description, localization: @gene.localization, name: @gene.name, position: @gene.position} }
    end
  ...
  test "should update gene" do
    patch gene_url(@gene), params: { gene: { chromosome_number: @gene.chromosome_number, description: @gene.description, localization: @gene.localization, name: @gene.name, position: @gene.position} }

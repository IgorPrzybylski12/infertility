...
class ProteinsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create protein" do
    assert_difference("Protein.count") do
      post proteins_url, params: { protein: { description: @protein.description, name: @protein.name } }
    end
  ...
  test "should update protein" do
    patch protein_url(@protein), params: { protein: { description: @protein.description, name: @protein.name } }

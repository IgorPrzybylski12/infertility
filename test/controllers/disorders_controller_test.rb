...
class DisordersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create disorder" do
    assert_difference("Disorder.count") do
      post disorders_url, params: { disorder: { description: @disorder.description, gender: @disorder.gender, name: @disorder.name } }
    end
  ...
  test "should update disorder" do
    patch disorder_url(@disorder), params: { disorder: { description: @disorder.description, gender: @disorder.gender, name: @disorder.name } }
